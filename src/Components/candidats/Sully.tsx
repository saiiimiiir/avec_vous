...
export default class Sully extends Component {
    render() {
        return (
            <div id="presentationCandidat">
                ...
                <div className="titulaire">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/sully/LINE-FLEURY.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    61 ans, mariée. Line est 1ère Adjointe de Saint-Brisson-sur-Loire, 
                                    Conseillère Communautaire à la Communauté des Communes giennoises, Conseillère départementale depuis 2015<br />
                                </em>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/sully/JEAN-LUC-RIGLET.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    58 ans, marié. Jean-Luc est Maire de Sully-sur-Loire depuis 2014, Vice-Président de la Communauté de Communes Val de Sully, 
                                    Conseiller Départemental du canton de Sully-sur-Loire<br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="supleant">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/sully/NATHALIE-HENRY.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçante<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    42 ans, Pédicure Podologue DE, mariée, 4 enfants. <br/> 
                                    Nathalie est Conseillère municipale à Coullons depuis 2014 et remplaçante de Line Fleury au Département depuis 2015<br />
                                </em>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/sully/HUGO-PLANCHER.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçant<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    28 ans, marié, 1 enfant. Ugo dirige une entreprise sur le Canton. <br/> 
                                    Il est Maire de Saint-Aignan-le-Jaillard, Conseiller communautaire Val de Sully<br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="contact">
                    ...
                    <div className="programLink">
                        ...
                        <a href="https://fr.calameo.com/read/001161664aeae0bad4dfd?authid=tUhFXXl4yM6W" target="_blank"><span >
