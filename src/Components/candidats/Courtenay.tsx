...
export default class Courtenay extends Component {
    render() {
        return (
            <div id="presentationCandidat">
                ...
                <div className="titulaire">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/courtenay/corinne-melzassard.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Conseillère départementale sortante du canton de Courtenay, Conseillère municipale de Château-Renard, 
                                    Membre du Conseil d’administration du Service Départemental d’Incendie et de Secours <br />
                                </em>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/courtenay/F-Neraud.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Vice-président du Conseil départemental, Conseiller départemental sortant du canton de Courtenay, 
                                    Président du Pôle d’équilibre territorial et rural du Gâtinais montargois, 
                                    Conseiller municipal de Ferrières-en-Gâtinais<br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="supleant">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/courtenay/nathalie-lucas.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçante<br />
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/courtenay/stephane-hamon.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçant<br />
                ...
                <div className="contact">
                    <div className="contactIcon">
                        ...
                        <div className="socialIcon">
                            <a href="http://continuons-ensemble-canton-courtenay.fr" target="_blank"><i className="fas fa-globe"></i></a>
                        </div>
                    </div>
                    ...
                    <div className="programLink">
                        ...
                        <a href="https://fr.calameo.com/read/00116166409ed94989f1a?authid=B1KnnKslHnpo" target="_blank"><span >
