...
export default class Pithiviers extends Component {
    render() {
        return (
            <div id="presentationCandidat">
                ...
                <div className="titulaire">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/pithiviers/Marianne-DUBOIS.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Députée du Loiret, Secrétaire de la Commission de la défense nationale et des forces armées, Conseillère départementale<br />
                                </em>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/pithiviers/marc-gaudet.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Président du Conseil départemental du Loiret, Vice-Président de la Communauté de Communes du Pithiverais, Agriculteur<br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="supleant">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/pithiviers/Latifa-MIQYASS.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçante<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Médecin généraliste à Bazoches-les-Gallerandes <br />
                                </em>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/pithiviers/Christophe-GUERTON.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçant<br />
                            ...
                            <p>
                                <em className="lineHeight">
                                    Maire d’Autruy-sur-Juine, Agriculteur <br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="contact">
                    ...
                    <div className="programLink">
                        ...
                        <a href="https://fr.calameo.com/read/0011616645376437cdef5?authid=3YkHhYL1DQ9M" target="_blank"><span >
