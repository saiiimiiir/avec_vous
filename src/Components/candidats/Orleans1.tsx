...
export default class Orleans1 extends Component {
    render() {
        return (
            <div id="presentationCandidat">
                ...
                <div className="titulaire">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/orleans1/Nadia-LABADIE.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/orleans1/Jean-Pierre-GABELLE.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                            ...
                            <p>
                                ...
                                <em className="lineHeight">
                                    ...
                                    Connaissant bien mon canton et ses habitants, je souhaite ardemment poursuivre au sein du Conseil départemental les actions volontaristes à destination des orléanais et des loirétains pour leur bien être au quotidien.<br />
                                </em>
                            </p>
                        </div>
                    </div>
                ...
                <div className="supleant">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/orleans1/Delphine--de-VERNEUIL.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçante<br />
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/orleans1/Bruno-VANNIER.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                Remplaçant<br />
