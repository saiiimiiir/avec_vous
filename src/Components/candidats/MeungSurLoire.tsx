        ...
        return (
            <div id="presentationCandidat">
                ...
                <div className="titulaire">
                    ...
                    <div className="fiche">
                        ...
                        <div className="text">
                            ...
                            <p>
                                <em>
                                    Maire de Meung-sur-Loire depuis 2008 – 6 500 habitants<br /><br/>
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/meung-sur-loire/t_bracquemond.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
                ...
                <div className="supleant">
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/meung-sur-loire/e_manchec.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                supléant<br />
                    ...
                    <div className="fiche">
                        <div className="image">
                            <img src={process.env.PUBLIC_URL + "/candidat_canton/meung-sur-loire/p_voisin.jpg"} />
                        </div>
                        <div className="text">
                            <h3 className="titre">
                                titulaire<br />
